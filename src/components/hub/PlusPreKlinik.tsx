      ...
      <main className="flex-1 p-10 grid grid-cols-12 grid-rows-6 gap-6 relative z-10 overflow-y-auto custom-scrollbar">
        ...
        <div className="col-span-8 row-span-4 bg-white/[0.03] border border-white/10 backdrop-blur-md rounded-[2.5rem] p-10 shadow-2xl">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-300 italic">AI_GÜDÜMLÜ_ZAMAN_ÇİZELGESİ</h3>
          </div>
          <div className="space-y-6">
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-3xl group hover:bg-white/[0.05] transition-all cursor-pointer">
              <div className="flex justify-between items-center"><h4 className="text-sm font-bold text-white group-hover:text-blue-300">Fizyoloji: Aksiyon Potansiyeli</h4><span className="text-xs font-black text-blue-500">14:00</span></div>
        ...
        <div className="col-span-4 row-span-3 bg-gradient-to-br from-indigo-600/20 to-blue-600/10 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-between">
           ...
           <div><p className="text-[10px] font-black uppercase text-blue-300 mb-2 tracking-widest">GÜNLÜK HEDEF</p><h4 className="text-2xl font-black italic tracking-tighter">150 SPOT BİLGİ</h4></div>
        </div>
        ...
        <div className="col-span-12 row-span-1 bg-blue-600 rounded-[2rem] px-8 flex items-center justify-between shadow-xl shadow-blue-600/20 mt-4">
           <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest italic text-white"><Headphones className="w-5 h-5"/> ODAK MODU: DEEP WORK LOFI</div>
